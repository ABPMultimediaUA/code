...
void Juego::StarUP(IrrlichtDevice* iDevice) {
	...
	//menu->loadScheme("TaharezLook.scheme");
	menu->loadScheme("VanillaSkin.scheme");

	menu->setFont("DejaVuSans-10");
	CEGUI::PushButton* testButton = static_cast<CEGUI::PushButton*>(menu->createWidget("Vanilla/Button", glm::vec4(0.5f, 0.5f, 0.1f, 0.05f), glm::vec4(0.0f), "TestButton"));
	testButton->setText("HOLA MUNDO");
	//CEGUI
}
