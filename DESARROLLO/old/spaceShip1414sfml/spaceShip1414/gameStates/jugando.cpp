...
jugando::jugando(unsigned int width, unsigned int height) : estadosJuego("playingState"), arma{ 0 }, balas{ 10 }, opciones{ false }, rec{ false }, pausa{ false }, vida{ 145.f }, vidaMax{ 250.f },
...
tPlay{ nullptr }, iArma{ nullptr }, iVida{ nullptr }, tVida{ nullptr }, rectangle{ nullptr }, reloj{ nullptr }, fFondo{ nullptr }, tFondo{ nullptr }
{
	tArma[0] = nullptr;
	tArma[1] = nullptr;
}
