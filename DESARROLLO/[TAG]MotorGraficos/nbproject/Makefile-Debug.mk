...
${OBJECTDIR}/arbolMotorGrafico/TNodo.o: arbolMotorGrafico/TNodo.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/arbolMotorGrafico/TNodo.o arbolMotorGrafico/TNodo.cpp
...
${OBJECTDIR}/entidadesMotorGrafico/TLuz.o: entidadesMotorGrafico/TLuz.cpp
	${MKDIR} -p ${OBJECTDIR}/entidadesMotorGrafico
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/entidadesMotorGrafico/TLuz.o entidadesMotorGrafico/TLuz.cpp

${OBJECTDIR}/entidadesMotorGrafico/TMalla.o: entidadesMotorGrafico/TMalla.cpp
	${MKDIR} -p ${OBJECTDIR}/entidadesMotorGrafico
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/entidadesMotorGrafico/TMalla.o entidadesMotorGrafico/TMalla.cpp

${OBJECTDIR}/entidadesMotorGrafico/TTransform.o: entidadesMotorGrafico/TTransform.cpp
	${MKDIR} -p ${OBJECTDIR}/entidadesMotorGrafico
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/entidadesMotorGrafico/TTransform.o entidadesMotorGrafico/TTransform.cpp
...
${OBJECTDIR}/tools/glm/detail/dummy.o: tools/glm/detail/dummy.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tools/glm/detail/dummy.o tools/glm/detail/dummy.cpp

${OBJECTDIR}/tools/glm/detail/glm.o: tools/glm/detail/glm.cpp
	${MKDIR} -p ${OBJECTDIR}/tools/glm/detail
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tools/glm/detail/glm.o tools/glm/detail/glm.cpp
