...
#include "readJson.h"
#include "tools/rapidjson/filereadstream.h"
#include "tools/rapidjson/document.h"
#include "tools/rapidjson/pointer.h"
#include "tools/rapidjson/istreamwrapper.h"
#include <fstream>
#include <cstdio>
#include <string>
...
readJson::readJson(Escenario *e) {
	...
	leerArchivo("resourse/levels/Puente.json");
	esce = e;
	crearPared();
}
