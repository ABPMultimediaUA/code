...
CEGUI::Window * GUI::createWidget(const std::string & type, const std::string & type1)
{
	CEGUI::Window* newWindow = CEGUI::WindowManager::getSingleton().createWindow(type, type1);
	m_root->addChild(newWindow);
	return newWindow;
}
