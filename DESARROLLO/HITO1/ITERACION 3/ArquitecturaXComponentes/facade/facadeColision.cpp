...
unsigned long facadeColision::newEntity2D(vector3 v){
    entityMap->insert(std::make_pair(numEntity2D,new Entity2D(world,v)));
    return numEntity2D++;
}

unsigned long facadeColision::newEntity2D(vector3 v, vector3 r, bool s){
    entityMap->insert(std::make_pair(numEntity2D,new Entity2D(world,v,r,s)));
    return numEntity2D++;
}

vector3 facadeColision::moveEntity2D0(int p, vector2 v){
    std::map<int, Entity2D*>::iterator entity = entityMap->find(p);
    entity->second->getCuerpo2D()->SetLinearVelocity(b2Vec2(v.getX(), 0.0f));
    return vector3(entity->second->getCuerpo2D()->GetPosition().x,0.0f,entity->second->getCuerpo2D()->GetPosition().y);
}

vector3 facadeColision::moveEntity2D1(int p, vector2 v){
    std::map<int, Entity2D*>::iterator entity = entityMap->find(p);
    entity->second->getCuerpo2D()->SetLinearVelocity(b2Vec2(-v.getX(), 0.0f));
    return vector3(entity->second->getCuerpo2D()->GetPosition().x,0.0f,entity->second->getCuerpo2D()->GetPosition().y);
}

vector3 facadeColision::moveEntity2D2(int p, vector2 v){
    std::map<int, Entity2D*>::iterator entity = entityMap->find(p);
    entity->second->getCuerpo2D()->SetLinearVelocity(b2Vec2(0.0f, v.getY()));
    return vector3(entity->second->getCuerpo2D()->GetPosition().x,0.0f,entity->second->getCuerpo2D()->GetPosition().y);
}

vector3 facadeColision::moveEntity2D3(int p, vector2 v){
    std::map<int, Entity2D*>::iterator entity = entityMap->find(p);
    entity->second->getCuerpo2D()->SetLinearVelocity(b2Vec2(0.0f, -v.getY()));
    return vector3(entity->second->getCuerpo2D()->GetPosition().x,0.0f,entity->second->getCuerpo2D()->GetPosition().y);
}

vector3 facadeColision::moveEntity2D4(int p, vector2 v){
    std::map<int, Entity2D*>::iterator entity = entityMap->find(p);
    entity->second->getCuerpo2D()->SetLinearVelocity(b2Vec2(v.getX(),v.getY()));
    return vector3(entity->second->getCuerpo2D()->GetPosition().x,0.0f,entity->second->getCuerpo2D()->GetPosition().y);
}

vector3 facadeColision::moveEntity2D5(int p, vector2 v){
    std::map<int, Entity2D*>::iterator entity = entityMap->find(p);
    entity->second->getCuerpo2D()->SetLinearVelocity(b2Vec2(v.getX(), -v.getY()));
    return vector3(entity->second->getCuerpo2D()->GetPosition().x,0.0f,entity->second->getCuerpo2D()->GetPosition().y);
}

vector3 facadeColision::moveEntity2D6(int p, vector2 v){
    std::map<int, Entity2D*>::iterator entity = entityMap->find(p);
    entity->second->getCuerpo2D()->SetLinearVelocity(b2Vec2(-v.getX(), -v.getY()));
    return vector3(entity->second->getCuerpo2D()->GetPosition().x,0.0f,entity->second->getCuerpo2D()->GetPosition().y);
}

vector3 facadeColision::moveEntity2D7(int p, vector2 v){
    std::map<int, Entity2D*>::iterator entity = entityMap->find(p);
    entity->second->getCuerpo2D()->SetLinearVelocity(b2Vec2(-v.getX(), v.getY()));
    return vector3(entity->second->getCuerpo2D()->GetPosition().x,0.0f,entity->second->getCuerpo2D()->GetPosition().y);
}
void facadeColision::setEntity2DVelocity(int p, vector2 v){
    std::map<int, Entity2D*>::iterator entity = entityMap->find(p);
    entity->second->getCuerpo2D()->SetLinearVelocity(b2Vec2(v.getX(), v.getY()));
}